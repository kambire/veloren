...
common-abilities-entrenador-latigo_espinas = Látigo de espinas
    .desc = Lanza un rayo débil de espinas que drena un poco de vida a tus enemigos.
common-abilities-entrenador-aura_vital = Aura vital
    .desc = Cura un poco a todo tu grupo, mascotas incluidas. No necesita combo.
