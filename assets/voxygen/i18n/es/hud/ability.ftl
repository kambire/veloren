...
common-abilities-sceptre-sanacion = Luz sanadora
    .desc = Cura a todo tu grupo, mascotas incluidas. No necesita combo.
common-abilities-entrenador-latigo_espinas = Bola de Poder
    .desc = Dispara una veloz esfera de energía salvaje que impacta e inflige daño en área, restaurando energía.
common-abilities-entrenador-aura_vital = Aura vital
    .desc = Restaura un 20% de salud al instante ("de una") y continúa regenerando vida durante 8 segundos.
common-abilities-entrenador-vinculo_salvaje = Vínculo salvaje
    .desc = Acelera a tu grupo y a tus mascotas: atacan y se mueven más rápido.
