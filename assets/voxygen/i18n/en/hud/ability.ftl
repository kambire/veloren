...
common-abilities-entrenador-latigo_espinas = Thorn Lash
    .desc = Shoots a weak beam of thorns that drains a little life from your enemies.
common-abilities-entrenador-aura_vital = Vital Aura
    .desc = Slightly heals your whole group, pets included. Does not need combo.
