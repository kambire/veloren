...
common-abilities-sceptre-sanacion = Healing Light
    .desc = Heals your whole group, pets included. Does not need combo.
common-abilities-entrenador-latigo_espinas = Power Orb
    .desc = Fires a fast wild energy sphere that impacts and deals area damage, restoring energy on hit.
common-abilities-entrenador-aura_vital = Vital Aura
    .desc = Instantly restores 20% max health to your group and pet, followed by continuous regeneration.
common-abilities-entrenador-vinculo_salvaje = Wild Bond
    .desc = Hastens your group and your pets, making them attack and move faster.
