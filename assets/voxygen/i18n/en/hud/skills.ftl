...
hud-skill-sc_lifesteal_title = Shadow: Lifesteal Beam
hud-skill-sc_lifesteal = Priest damage branch. Drain the life from your enemies.
...
hud-skill-sc_heal_title = Holy: Healing Light
hud-skill-sc_heal = Priest healing branch. Heal your whole group, pets included, without needing combo.
...
hud-skill-sc_wardaura_unlock_title = Discipline: Warding Aura
hud-skill-sc_wardaura_unlock = Priest protection branch. Allows you to ward your allies against enemy attacks.{ $SP }
...
hud-skill_tree-tamer = Tamer
hud-skill-tm_pack_title = Pack
hud-skill-tm_pack = Pet branch. Your beasts hit harder and take more punishment.
hud-skill-tm_pet_damage_title = Pack Strength
hud-skill-tm_pet_damage = Your pets deal { $boost } % more damage.{ $SP }
hud-skill-tm_pet_defense_title = Thick Hide
hud-skill-tm_pet_defense = Your pets take { $boost } % less damage per level.{ $SP }
hud-skill-tm_tame_title = Taming
hud-skill-tm_tame = Capture branch. Use collars to tame wild beasts up to your level.
hud-skill-tm_capture_title = Expert Tamer
hud-skill-tm_capture = You can capture beasts { $boost } levels above your own.{ $SP }
hud-skill-tm_nature_title = Nature
hud-skill-tm_nature = Support branch. Improves the abilities of your crook.
hud-skill-tm_vital_heal_title = Improved Vital Aura
hud-skill-tm_vital_heal = Vital Aura heals { $boost } % more.{ $SP }
hud-skill-tm_bond_title = Strong Bond
hud-skill-tm_bond = Wild Bond hastens your group and pets { $boost } % more.{ $SP }
